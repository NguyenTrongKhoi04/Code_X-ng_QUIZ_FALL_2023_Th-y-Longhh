                ...
                <form class="col-sm-6">
                    <div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input ng-model="Student.username" class="form__email" type="text" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <span>Email:</span>
                                <input  ng-model="Student.email"class="form__email" id="email" type="text" />
                            </div>
                            <div class="col-sm-6">
                              <span>Ngày sinh:</span>
                              <input  ng-model='Student.birthday'class='form__email' type="date" id="bd" value="." />
                          </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <span>Điểm:</span>
                                <input ng-model="Student.marks"class="form__email" type="text" readonlyq />
                            </div>
                            <div class="col-sm-6">
                              <span>Giới tính: </span>
                              <div class="rdo">
